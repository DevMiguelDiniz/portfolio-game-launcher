        ...
        <div className="h-full overflow-y-auto bg-gray-950">
            ...
            <div className="p-8">
                <div className="max-w-6xl mx-auto space-y-12">
                    {/* About */}
                    <section>
                        <h2 className="text-3xl font-bold text-white mb-6">{t('profile.title')}</h2>
                    ...
                    {/* Skills */}
                    <section>
                        <h2 className="text-3xl font-bold text-white mb-6">{t('profile.skills')}</h2>
                    ...
                    {/* Experience */}
                    <section>
                        <h2 className="text-3xl font-bold text-white mb-6">{t('profile.experience')}</h2>
                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                                        ...
                                        <div className="flex items-center space-x-2 mt-2 md:mt-0">
                                            ...
                                            {exp.current && <span className="px-2 py-1 bg-blue-600 text-white text-xs rounded">{t('profile.current')}</span>}
                                        </div>
                                    </div>
